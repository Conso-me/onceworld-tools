      ...
      <div className="grid grid-cols-[1fr_auto] gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            placeholder="1"
            className="w-28 px-3 py-2.5 bg-white border border-gray-200 rounded-xl text-center font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
      </div>
